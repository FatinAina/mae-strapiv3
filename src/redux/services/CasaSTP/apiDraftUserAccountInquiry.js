...
import { draftUserAccountInquiryService } from "@services/apiServicePremier";
...
export const draftUserAccountInquiryPremier = (subUrl, dataReducer, callback, m2uIndicator) => {
    return async (dispatch) => {
        ...
        try {
            ...
            // this error code is for score party failure in resume case
            if (errorCode !== 4994) {
                showErrorToast({
            ...
            dispatch({ type: DRAFT_USER_ACCOUNT_INQUIRY_ERROR, error });
        }
    };
};
