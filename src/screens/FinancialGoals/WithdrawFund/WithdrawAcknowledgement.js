...
const WithdrawAcknowledgement = ({ navigation, route }) => {
    useEffect(() => {
        logEvent(FA_VIEW_SCREEN, {
            [FA_SCREEN_NAME]: "FinancialGoals_WithdrawFunds_Successful",
        });
    ...
    async function onShareReceiptTap() {
        ...
        try {
            ...
            const receiptTitle = "Withdraw fund financial goals";
            const detailsArray = [
                {
                    label: "Reference Id",
                    value: route?.params?.referenceId,
...
WithdrawAcknowledgement.propTypes = {
    navigation: PropTypes.object,
    route: PropTypes.object,
};

export default WithdrawAcknowledgement;
