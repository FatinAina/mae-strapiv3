...
const NonIetApplicationFinancingSuccessful = ({ navigation, route }) => {
    const submitResponse = route.params?.submitResponse;
    const { getModel } = useModelController();

    logEvent(FA_FORM_COMPLETE, {
        [FA_SCREEN_NAME]: "Apply_ASBFinancing_FinancingSuccessful",
    ...
    return (
        <ScreenContainer
            ...
            analyticScreenName="Apply_ASBFinancing_FinancingSuccessful"
        >
            <ScreenLayout
                header={<HeaderLayout />}
                useSafeArea
...
NonIetApplicationFinancingSuccessful.propTypes = {
    route: PropTypes.object,
    navigation: PropTypes.object,
};
export default React.memo(NonIetApplicationFinancingSuccessful);
